...
import edu.cmu.ioio.ProximityDetector;
import edu.cmu.ioio.R;
...
public class StepService extends Service {
	private static final String TAG = "edu.cmu.distance.StepService";
    ...
    private void showNotification() {
        ...
        pedometerIntent.setComponent(new ComponentName(this, ProximityDetector.class));
